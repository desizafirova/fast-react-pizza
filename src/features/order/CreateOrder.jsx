      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="bg-red-100p-2 mt-2 rounded-md text-xs text-red-700">
                {formErrors.phone}
              </p>
            )}
          </div>
...
export async function action({ request }) {
  ...
  // hack which we don't have to overuse because it deactivates several of Redux' optimizations
